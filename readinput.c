      ...
      *pname = '\0';
      ...
      /***** Coordinate transformations **************************************/
               ...
               (!strcasecmp(word, "transv")) || (!strcasecmp(word, "transa")))
        {
          ...
          params = GetParams(word, input, &np, &i0, 2, 17, fname);
          ...
          while (j < np)
            {
              ...
              if (!strcmp(str, "de"))
              ...
              else if (!strcmp(str, "dfet"))
                {
                  ...
                  loc1 = ReallocMem(DATA_ARRAY, FET_PARAMS_SIZE);
                  WDB[loc0 + DET_FET_PTR_PARAMS] = loc1;

                  /* Read type */

                  WDB[loc1 + FET_PARAM_TYPE] =
                    TestParam(pname, fname, line, params[j++], PTYPE_INT, FET_TYPES_START, FET_TYPES_END);
