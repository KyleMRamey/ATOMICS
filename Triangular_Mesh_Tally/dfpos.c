...
{
  long ptr, tri, i, j, k, type;
  double div, p, px, py, pz, d2;
  const double *param;
    ...
    case SURF_HEXYC:
      {
        ...
        GetLatticeIndexes(p, p, p, x, y, z, &tri, &i, &j, &k, LAT_TYPE_HY);
        ...
        *l2 = -1;
        ...
        GetLatticeIndexes(p, p, p, x, y, z, &tri, &i, &j, &k, LAT_TYPE_HX);
    ...
    case SURF_HEXYPRISM:
      {
        ...
        GetLatticeIndexes(p, p, pz, x, y, z, &tri, &i, &j, &k, LAT_TYPE_HY);
        ...
        *l2 = -1;
        ...
        GetLatticeIndexes(p, p, pz, x, y, z, &tri, &i, &j, &k, LAT_TYPE_HX);
